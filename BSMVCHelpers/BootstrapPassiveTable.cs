...
namespace Ovixon.Bootstrap
{
    ...
    {
        public static MvcHtmlString BootstrapPassiveTable(this HtmlHelper htmlHelper, List<List<string>> elements, List<string> headers = null, List<string> footers = null,
    ...
    public class BootstrapTableStyles
    {
        public BootstrapTableStyles(string caption = "", bool bordered = false, bool striped = false, bool hover = false, bool condensed = false)
        {
    ...
    public enum BootstrapRowStyleType
    {
        none,
        success,
        error,
